...
public class Program
{
    ...
    private static Project CreateProject(CustomVisionTrainingClient trainingApi)
    {
       ...
       return trainingApi.CreateProject("My New Project", null, objDetectionDomain.Id);
    ...
    private static void PublishIteration(CustomVisionTrainingClient trainingApi, Project project)
    {
        ...
        publishedModelName = "toolModel";
        var predictionResourceId = "/subscriptions/1598e60e-cbcc-4093-a1fd-a6a6ea0d7dd8/resourceGroups/congnitive-svc-rg/providers/Microsoft.CognitiveServices/accounts/customvisiontransunion-Prediction";
